...
function openModal(language, percentage) {
  ...
  modalIcon.src = `./assets/images/tech stack/${language}.svg`;
  modalLanguage.textContent = capitalizeFirstLetter(language);
...
// Helper function to capitalize the first letter of the language name
